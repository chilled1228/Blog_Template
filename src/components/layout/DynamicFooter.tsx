...
import { Brain, Twitter, Facebook, Instagram, Send } from 'lucide-react';
  ...
  return (
    <footer className="mt-16 bg-stone-100/50 border-t border-stone-200/60 text-stone-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Bottom Bar */}
        <div className="py-6 border-t border-stone-200/60 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-sm text-stone-500 text-center sm:text-left mb-4 sm:mb-0">
            &copy; {new Date().getFullYear()} behindthebrain. All Rights Reserved.
          </p>
          <div className="flex space-x-4">
            <Link href="#" className="text-stone-500 hover:text-teal-600 transition-colors"><Twitter className="h-5 w-5" /></Link>
            <Link href="#" className="text-stone-500 hover:text-teal-600 transition-colors"><Facebook className="h-5 w-5" /></Link>
            <Link href="#" className="text-stone-500 hover:text-teal-600 transition-colors"><Instagram className="h-5 w-5" /></Link>
          </div>
        </div>
      </div>
    </footer>
