        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10 lg:gap-12">
          ...
          <div className="col-span-2 sm:col-span-2 lg:col-span-1">
            ...
            <p className={`${typography.bodySmall} text-inherit mb-4 sm:mb-6 max-w-sm`}>
              behindthebrain - Empowering personal growth through self-help, mindfulness, productivity, and life transformation.
            </p>
            <div className="flex space-x-3 sm:space-x-4">
              <Link href="https://twitter.com/behindthebrain" target="_blank" rel="noopener noreferrer" 
              ...
              <Link href="https://facebook.com/behindthebrain" target="_blank" rel="noopener noreferrer" 
                    className="text-inherit hover:text-inherit transition-colors duration-200 p-1">
                <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </Link>
              <Link href="https://instagram.com/behindthebrain" target="_blank" rel="noopener noreferrer" 
                    className="text-inherit hover:text-inherit transition-colors duration-200 p-1">
                <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link href="/category/personal-growth" 
              ...
              <li>
                <Link href="/category/mindfulness" 
                      className={`${typography.link} text-inherit hover:text-inherit flex items-center group`}>
                  <span className="w-1 h-1 bg-inherit rounded-full mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200"></span>
                  Mindfulness
                </Link>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link href="https://behindthebrain.com" target="_blank" rel="noopener noreferrer" 
                      className={`${typography.link} text-inherit hover:text-inherit flex items-center group`}>
                  <span className="w-1 h-1 bg-inherit rounded-full mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200"></span>
                  behindthebrain
                </Link>
        ...
        <div className="mt-8 sm:mt-10 lg:mt-12 pt-6 sm:pt-8 border-t border-gray-200">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className={`${typography.metaSmall} text-inherit text-center sm:text-left`}>
              © 2025 behindthebrain. All rights reserved.
            </p>
